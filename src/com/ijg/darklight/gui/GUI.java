...
import com.ijg.darklight.core.Engine;

/**
 * Basic graphic user interface to show information about the current Darklight session
 * @author Isaac Grant
...
public class GUI {
	...
	/**
	 * 
	 * @param engine The instance of engine to which this gui will belong
	 */
